...
export const employment: ReadonlyArray<Employment> = [
    {
      ...
      text: {
        da: [
          ...
          <>
            Jeg visualiserede systemarkitekturen innovativt og gav frisk
            indsigt, der hjalp teamet med at forstå platformen bedre.
          </>,
        ],
        en: [
          <>
          ...
          <>
            Visualised system architecture innovatively, providing fresh
            insights that helped the team understand the platform better.
          </>,
        ],
      },
    },
    {
      ...
      text: {
        da: [
          ...
          <>
            Jeg løftede teampræstationer ved at coache og vejlede
            holdkammerater, og jeg drev vedtagelsen af bedste praksis.
          </>,
          <>
        ...
        en: [
          <>
            Acted as Tech Lead for two engineering teams, significantly
            improving team performance and product delivery across the product
            suite.
          </>,
          <>
            Elevated team performance by coaching and mentoring teammates,
          ...
          <>
            Shaped organisational standards and fostered a culture of
            operational excellence and continuous improvement, extending impact
            beyond my own teams.
          </>,
          <>
            Promoted inclusion and diversity, fostering a healthy and safe
            culture for the benefit of the organisation.
          </>,
        ],
      },
    },
    {
      ...
      text: {
        da: [
          ...
          <>
            Jeg stod i spidsen for migreringen fra et stort on-premises system
            til cloud-baserede mikrotjenester, der markant forbedrede
            skalerbarheden og præstation.
          </>,
          <>
            Mit team leverede hidtil uset streamingadgang til London OL 2012,
            med kapacitet til et massivt landsdækkende publikum.
          </>,
          <>
