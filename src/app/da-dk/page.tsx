    ...
    <html>
      ...
      <body>
        ...
        <section className="pitch">
          <h2>Erfaren Software Ingeniør og Teknisk Leder</h2>
        ...
        <section className="employment">
          ...
          <ol>
            <li>
              ...
              <p>
                Hack Your Future tilbyder et software “bootcamp”-slags kursus
                til flygtninger, indvandrer, og andre udsatte i det danske
                arbejdsmarked.
            ...
            <li>
              ...
              <p>
                ...
                database, deployet til Scalingo ved hjælp af GitHub Actions.
                REST via OpenAPI skema.
              </p>
              <p>
                ...
                noget, som de ikke kendte til deres eget system. Så rettede vi
                op disse punkter, hvilket øgede dokumentationsnøjagtigheden og
                reducerede omkostninger og friktion.
              </p>
              <p>
                Jeg bidrog med adskillige forbedringer til CI-kæden, fx med
                muligheden for at målrette et specifikt library ved opgradering
                af afhængigheder, hvorved størrelsen og risikoen reduceres af
            ...
            <li>
              ...
              <p>
                <Sk>The stack</Sk>: overvejende en stor Ruby on Rails monolit,
                der bruger et MySQL-datalager og Kafka til messaging; deployet
                vha GitHub Actions og Spinnaker til en række Kubernetes clusters
                i AWS. Derudover diverse mikrotjenester i Ruby on Rails eller
              ...
              <p>
                Zendesk laver software til styring af kunderelationer (som
                kaldes også "Zendesk"). Virksomheden har kontorer og
                ingeniørteams rundt om i verden med flere end 1500 ingeniører.
                Københavnskontoret tager sig for det meste af ét produkt inden
                for Zendesk-pakken, nemlig "Guide", med 8 hold. Jeg var teknisk
                leder for ét af disse hold.
              </p>

              <p>
                Som tech lead var jeg ansvarlig for at sikre, at mit teams
                arbejde var i overensstemmelse med relevante standarder og
                retningslinjer, og jeg fungerede som en muliggørende gateway
                (hvor påkrævet) mellem mit team og det bredere
                Zendesk-ingeniørsamfund. Jeg tog en aktiv rolle i den tekniske
                udvikling i dette samfund ved at bidrage ideer, spørgsmål og
                kommentarer til tekniske dokumenter. Jeg var også god til at
                identificere kanttilfælde og tvetydige områdespecifikationer, og
                dermed til at gøre dem mere robuste og omfattende.
              </p>

              <p>
                Jeg samarbejdede med kollegaer fra mange steder og tidszoner
                rundt omkring i verden, især San Francisco, Melbourne og
                Filippinerne. Som en individuel bidragyder arbejdede jeg mest i
                Ruby, Typescript, SQL (MySQL-variant), Kubernetes, Docker,
                Google Cloud og AWS. Jeg havde en særlig interesse i at forbedre
                vores produktsikkerhed og stabilitet. Ved at identificere
                problemhuller og så foreslå og implementere løsninger, hjalp jeg
            ...
            <li>
              ...
              <p>
                ...
                transformation: vores produkt gik fra at være en
                uvedligeholdelig, upålidelig, on-site database-drevet Perl
                monolit, til en velfungerende skalerbar samling af{" "}
                <Sk>meddelelsesdrevne mikrotjenester</Sk> lavet i <Sk>Java</Sk>{" "}
                og hostet i <Sk>AWS</Sk>. Som en del af dette forændring lærte
                vi igen hvordan man skaber og leverer software ved at indføre
              ...
              <p>
                ...
                hvoraf det ene blev ledet af mig. Mit arbejde omfattede
                mennesker ledelse, scrum-ledelse, teknisk ledelse og dag-til-dag
                teamvejledning; og at coache og at vejlede mine individuelle
                teammedlemmer. Jeg samarbejdede med vores hovedarkitekt for at
                nå frem til et robust design. Jeg kommunikerede så visionen til
                teamet, og deltog i planlægning og raffinering; og så vidt
                muligt også at være en individ kode bidragyder.
              </p>
              ...
              <p>
                På forskellige tidspunkter var jeg også sysadmin til min
                afdelings udviklingsmiljø. Jeg arbejdede også på
                "/programmes"-projektet, det handler om udgivelsen af én side
                for hvert BBC-program ved hjælp af en standard, automatisk
                udgivelsespipeline baseret på <Sk>Ruby on Rails</Sk> og{" "}
                <Sk>Perl</Sk>. Til sidst trænede jeg et scrum-hold i 3 måneder,
                fungerende som en "gæst" hovedingeniør, der hjalp med at starte
                holdet i den rigtige retning. Sådan forbedrede jeg teamets
                scrum-effektiviteten. Jeg gav vejledning til holdets anden
                hovedingeniør, som ville fortsætte efter jeg havde taget min
                afsked.
              </p>
              ...
              <p>
                ...
                forskellige målgrupper: alt fra 5 minutter til 50, 5 personer
                til 200; internt i mit team, eller min afdeling, eller hele BBC
                engineering, eller eksternt / offentligt. Jeg blev bedt om at
                tale ved BBCs åbne dage, tech-topmøder, rekruttering dage osv.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Power Internet var en etableret internetudbyder, der også
                leverede "bare metal" server hosting og skræddersyet websted
                udvikling. Koden var næsten altid med <Sk>Perl</Sk> med{" "}
                <Sk>MySQL</Sk>.
              </p>

              <p>
                Jeg var pioner for skabelsen og brugen af velbyggede,
                velafprøvede genbrugelig bibliotekskode mellem projekter,
                hvilket forbedrede kodens sikkerhed, udviklingshastighed og
                portabilitet af programmør færdigheder mellem projekterne. Jeg
                promoverede også produktsikkerhed via forbedret validering,
                omhyggelig kodning og så videre.
              </p>
              ...
              <p>
                ...
                høj-tilgængelig og højhastigheds WAN'er. Jeg var ansvarlig for
                al softwaren bag produktet, inklusive webbaseret drift og
            ...
            <li>
              ...
              <p>
                ...
                Windows), <Sk>MS SQL Server</Sk> (på Windows). En stor del af
                mit arbejde var back-end, at skrive batchbehandling i C/SQL, og
                så senere på software til at indtage data fra hovedproduktet ind
                i et datavarehus.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                ...
                multinational konsulents- og servicevirksomhed. Hos deres branch
                i Bedford håndterede de deres kontrakt med Autoglass, en udbyder
                af reparation og udskiftning af bilglas. På CSC brugte jeg{" "}
                <Sk>VMS/DCL, V‑Test, SQL</Sk> (i første omgang en{" "}
                <Sk>Ingres</Sk> database, senere også{" "}
                <Sk>Informix og Oracle 7</Sk>), og <Sk>C med embedded SQL</Sk>.
                Jeg blev site ekspert i at bruge V-Test til belastningstest, og
                i batchbehandling på tværs af flere databaser. Jeg lærte om
                SQL-ydelse og databaseadministration for både Ingres og Oracle,
                og begyndte også at bruge unix og lære "the shell".
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                ...
                kontrollere varerne for fejl og sende varerne til producent
                eller lager efter behov.
              </p>
            </li>
          </ol>
        </section>
