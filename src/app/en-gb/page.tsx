        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>GraphQL, REST, TCP/IP, HTTP, DNS, more Internet Protocols</li>
              <li>Cryptography</li>
            </ul>
          </li>
        ...
        <ol>
          ...
          <li>
            ...
            <p>
              ...
              and inaccurate information in the picture of the system with which
              I was being presented. I was thus able to query these points, and
              in several cases teach the team something that they were not aware
              of about their own system. We then rectified those points, thus
              increasing documentation accuracy, decreasing costs, and reducing
              friction.
            </p>
            <p>
              I contributed several improvements to the build & deployment
              chain: for example, the ability to target a specific library when
              upgrading dependencies, thereby reducing the size and risk of
              changes. I also provided individual contributions to the
          ...
          <li>
            ...
            <p>
              ...
              GitHub Actions and Spinnaker to a series of Kubernetes clusters in
            ...
            <p>
              ...
              also called “Zendesk”). The company has offices and engineering
              teams around the world, with more than 1500 engineers. The
              Copenhagen office mostly looks after one product within the
              Zendesk suite, “Guide”, with 8 teams. I was tech lead for one of
              those teams.
            </p>
            ...
            <p>
              ...
              acted as an enabling gateway (where required) between my team and
              the wider Zendesk engineering community. I took an active role in
              technical developments in that community, contributing ideas,
              questions, and comments on technical documents; identifying edge
              cases and ambiguous areas specifications, and helping to make them
            ...
            <p>
              ...
              (MySQL variant), Kubernetes, Docker, Google Cloud and AWS. I took
              a special interest in improving our product security and
              stability. By identifying problem-gaps, and proposing and
              implementing solutions, I helped the Zendesk engineering community
              to make clearer decisions, simplify the product, and save time.
            </p>
          ...
          <li>
            ...
            <p>
              ...
              catch-up TV streaming service “iPlayer”, as well as iPlayer Radio.
            </p>
            <p>
              Around 2011–2013, Media Services underwent a major transformation:
              our product went from being an unmaintainable, unreliable, on-site
              database-driven Perl monolith, to a smoothly-functioning scalable
              collection of <Sk>message-driven microservices</Sk> written in{" "}
              <Sk>Java</Sk> and hosted in <Sk>AWS</Sk>. As part of this, we
              re-learned how create and deliver software, adopting a continuous
              delivery approach.
            </p>
            <p>
              Along the route, we pioneered the use of the cloud for a major BBC
              service, delivered BBC iPlayer content onto a delivery partner’s
              platform, and provided unprecedented live and on-demand online
            ...
            <p>
              ...
              management, scrum leadership, technical leadership, and day-to-day
              team guidance; coaching and mentoring my individual team members;
              working with our lead architect to arrive at a robust design;
          ...
          <li>
            ...
            <p>
              ...
              Windows), <Sk>MS SQL Server</Sk> (on Windows). A major part of my
              work was on the back end, writing batch processing in C/SQL, and
              then later on software to ingest data from the original product,
          ...
          <li>
            ...
            <p>
              ...
              administration for both Ingres and Oracle, and also started to use
              unix and learn the shell.
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              Watford Electronics was a retailer, principally of PC software and
              hardware. My role was to handle items returned by customers,
